...
endif # CONFIG_POLLY_CLANG

# Inlin optimization
ifdef CONFIG_INLINE_OPTIMIZATION
KBUILD_CFLAGS += -mllvm -inline-threshold=300 \
				 -mllvm -inlinehint-threshold=250 
...
LTO_LDFLAGS	:= $(LTO_CFLAGS) -Wno-lto-type-mismatch -Wno-psabi \
		   ...
		   --plugin-opt=-import-instr-limit=5 --plugin-opt=O3 --lto-O3
...
KBUILD_LDFLAGS += -mllvm -import-instr-limit=5 --plugin-opt=O3 --lto-O3
endif
